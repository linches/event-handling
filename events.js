...
function four() {
  ...
  four.addEventListener("click", myNewSmartListerner)
}
...
function myNewSmartListerner(evt) {
  if (evt.target.style.backgroundColor === "white" ||  evt.target.style.backgroundColor == "") {
    makePurple(evt)
  }
  else {
